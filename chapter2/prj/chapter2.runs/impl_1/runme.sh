...
HD_PWD='D:/CPU_Design/chapter2/prj/chapter2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log inst_fetch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source inst_fetch.tcl -notrace
