...
HD_PWD='D:/CPU_Design/chapter2/prj/chapter2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inst_fetch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inst_fetch.tcl
